...
const CustomShadows = (theme) => ({
  ...
  z1:
    theme.palette.mode === 'dark'
      ...
      : `0px 4px 15px ${alpha(theme.palette.grey[900], 0.05)}`,
  z2:
    // Note: Add z2 to improve the look of the menu. But it's applied to the popover, so if issues there
    // this is the change to revert.
    theme.palette.mode === 'dark'
      ? `0px 1px 1px rgb(0 0 0 / 14%), 0px 2px 1px rgb(0 0 0 / 12%), 0px 1px 3px rgb(0 0 0 / 20%)`
      : `0px 4px 15px ${alpha(theme.palette.grey[900], 0.15)}`,
  ...
  menu: `0 14px 12px ${alpha(theme.palette.grey[500], 0.5)}`,
})
